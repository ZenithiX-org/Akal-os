      ...
      {spotlightOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed top-1/4 left-1/2 -translate-x-1/2 z-[9701] w-[600px] max-w-[90vw] rounded-2xl overflow-hidden"
            style={{
              background: darkMode ? 'rgba(28,28,32,0.6)' : 'rgba(245,245,247,0.65)',
              backdropFilter: 'blur(50px) saturate(200%)',
              WebkitBackdropFilter: 'blur(50px) saturate(200%)',
              border: darkMode ? '1px solid rgba(255,255,255,0.18)' : '1px solid rgba(255,255,255,0.7)',
              boxShadow: darkMode ? '0 40px 100px rgba(0,0,0,0.7), inset 0 1px 1px rgba(255,255,255,0.15)' : '0 40px 100px rgba(0,0,0,0.3), inset 0 1px 1px rgba(255,255,255,0.9)',
            }}
