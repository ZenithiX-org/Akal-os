      ...
      {controlCenterOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed top-8 right-2 z-[9001] w-80 rounded-2xl p-3 space-y-2"
            style={{
              background: darkMode ? 'rgba(28,28,32,0.6)' : 'rgba(235,235,240,0.6)',
              backdropFilter: 'blur(40px) saturate(200%)',
              WebkitBackdropFilter: 'blur(40px) saturate(200%)',
              border: darkMode ? '1px solid rgba(255,255,255,0.15)' : '1px solid rgba(0,0,0,0.08)',
              boxShadow: darkMode ? '0 25px 70px rgba(0,0,0,0.6), inset 0 1px 0 rgba(255,255,255,0.12)' : '0 25px 70px rgba(0,0,0,0.2), inset 0 1px 0 rgba(255,255,255,0.8)',
            }}
