        ...
        <>
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-3 mb-3">
              {/* Clock widget */}
              <div className="rounded-2xl p-4 col-span-2" style={{ background: darkMode ? 'rgba(28,28,32,0.5)' : 'rgba(245,245,247,0.55)', backdropFilter: 'blur(30px) saturate(200%)', WebkitBackdropFilter: 'blur(30px) saturate(200%)', border: darkMode ? '1px solid rgba(255,255,255,0.12)' : '1px solid rgba(255,255,255,0.6)', boxShadow: 'inset 0 1px 1px rgba(255,255,255,0.1)' }}>
              ...
              {notifications.length === 0 ? (
                ...
                notifications.map((n) => (
                  <motion.div
                    ...
                    style={{
                      background: darkMode ? 'rgba(40,40,45,0.5)' : 'rgba(255,255,255,0.55)',
