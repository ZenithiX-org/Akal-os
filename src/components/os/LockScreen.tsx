    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center gap-6">
        ...
        <motion.div initial={{ scale: 0, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} transition={{ delay: 0.3, type: 'spring' }} onClick={() => setShowInput(true)} className="cursor-pointer">
          <div className="w-24 h-24 rounded-full flex items-center justify-center shadow-2xl border-2 border-white/30" style={{ background: 'rgba(0,113,227,0.5)', backdropFilter: 'blur(20px) saturate(180%)', WebkitBackdropFilter: 'blur(20px) saturate(180%)', boxShadow: '0 20px 60px rgba(0,0,0,0.4), inset 0 1px 1px rgba(255,255,255,0.2)' }}>
